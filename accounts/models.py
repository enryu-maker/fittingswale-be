...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    mobile_no = models.CharField(
        _('MobNumber'), null=True, blank=True, unique=True)
    pan_no = models.CharField(
        _('PanNumber'), max_length=50, null=True, blank=True, unique=True)
    gst_no = models.CharField(
        _('GstNumber'),  max_length=50, null=True, blank=True, unique=True)
    pan_card = models.FileField(
        upload_to="pancards", max_length=254, null=True, blank=True)
    gst_certificate = models.FileField(
        upload_to="gstcertificates", max_length=254, null=True, blank=True)
