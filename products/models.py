...
class MainCategory(models.Model):
    ...
    status = models.CharField(
        max_length=10, choices=DISABLE_CHOICES, default='Activate')
...
class Category(models.Model):
    main_category = models.ForeignKey(
        MainCategory, on_delete=models.CASCADE, null=True)
...
class RolePrice(models.Model):
    ...
    size = models.ForeignKey(
        SizeChart, on_delete=models.CASCADE, null=True, blank=True)
    gst_percent = models.DecimalField(
        max_digits=20, decimal_places=2, default=18, null=True)
    price_with_gst = models.DecimalField(
...
class MultiImages(models.Model):
    ...
    prod_img = models.ForeignKey("ProductImage", verbose_name=_(
        "Product Image"), on_delete=models.CASCADE, null=True)
...
class PaymentTransaction(models.Model):
    ...
    delivery_date = models.DateTimeField(
        _("Delivery Time"), auto_now=False, auto_now_add=False, null=True)
...
class Stock(models.Model):
    size_chart = models.OneToOneField(
        SizeChart, on_delete=models.CASCADE, related_name='stock_quantity')
